defmodule TeamsortWeb.CoreComponents do
  @moduledoc """
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        class={[
          ...
          "dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder:text-zinc-400 dark:border-zinc-400 dark:focus:border-zinc-300",
